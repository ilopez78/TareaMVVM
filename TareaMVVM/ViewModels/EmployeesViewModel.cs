            ...
            SaveCommand = new Command(async () => {
                if (Validate())
                {
                    ...
                    if (respuesta == Constants.SUCCESS)
                    {
                        ...
                        await Page.DisplayAlert("Datos", "Guardados Exitosamente.", "Aceptar");
                        await Page.Navigation.PopAsync();
                    }
                    else
                        await Page.DisplayAlert("Datos", "Error al guardar.", "Aceptar");
                    UserDialogs.Instance.HideLoading();
                }
                else
                    await Page.DisplayAlert("Advertencia", "Debe llenar todos los campos.", "Aceptar");
            });
        }
